const coursesData = [
    ...
    },
    {
        ...
        "longDescription": `
            <h4 class="font-bold text-gray-800 mb-3 text-xl">Course Outline</h4>
            <ul class="list-disc pl-5 space-y-3 text-gray-600">
                <li><strong class="text-gray-800">Best Practices:</strong> Body language, tone of voice, eye contact, and how to command the room.</li>
                <li><strong class="text-gray-800">Common Mistakes:</strong> Overcoming stage fright, avoiding "death by PowerPoint" (reading off slides), and eliminating filler words (um, uh).</li>
                <li><strong class="text-gray-800">Content Structuring:</strong> How to open with a hook, structure your main points, and end with a strong call-to-action.</li>
                <li><strong class="text-gray-800">Live Practicing:</strong> Interactive sessions where students deliver mock presentations and receive constructive, real-time feedback.</li>
            </ul>
        `,
        "instructor": "Mohamed Bakr",
        "instructorBio": "Mohamed Bakr is an experienced speaker and instructor who helps professionals and students overcome stage fright and deliver compelling, confident presentations.",
        "instructorPortfolio": "https://mfouadbakr.github.io/portfolio/index.html",
        ...
        <div class="flex flex-col md:flex-row bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="w-full md:w-1/3 bg-gray-100 relative overflow-hidden min-h-[240px]">
                <img src="https://images.unsplash.com/photo-1544928147-79a2dbc1f389?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Presentation Skills" class="w-full h-full object-cover absolute inset-0">
                <span class="absolute top-4 left-4 bg-gray-900/90 backdrop-blur-sm px-3 py-1 text-xs font-bold text-white rounded shadow-sm">Online</span>
            </div>
            <div class="w-full md:w-2/3 p-6 md:p-8 flex flex-col justify-between">
                <div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-3 font-poppins">Mastering Presentation Skills</h3>
                    <p class="text-gray-600 mb-6 leading-relaxed">Learn the art of public speaking, discover best practices, avoid common mistakes, and practice delivering impactful presentations.</p>
                ...
                <div class="mt-4 flex flex-col sm:flex-row justify-end gap-3">
                    <button onclick="copyCourseLink('course_presentationskills', this)" class="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 border border-gray-200 rounded-lg transition-colors w-full sm:w-auto">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z"></path></svg>
                        Share
                    </button>
                    <button onclick="showCourseDetail('course_presentationskills')" class="btn-custom w-full sm:w-auto shadow-sm">View Details</button>
                </div>
            </div>
        </div>`
    },
